...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(NotekeepingDatabaseContract.CourseInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(NotekeepingDatabaseContract.CourseInfoEntry.COLUMN_COURSE_TITLE, title);

        long newRowId = mDb.insert(NotekeepingDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
    }

     private void insertNote(String courseId, String title, String text) {
        ContentValues values = new ContentValues();
        values.put(NotekeepingDatabaseContract.NoteInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(NotekeepingDatabaseContract.NoteInfoEntry.COLUMN_NOTE_TITLE, title);
        values.put(NotekeepingDatabaseContract.NoteInfoEntry.COLUMN_NOTE_TEXT, text);

        long newRowId = mDb.insert(NotekeepingDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
    }
